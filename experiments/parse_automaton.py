...
#settings
max_sequence_length = 12 # we used 12 for scenario A, 10 for scenario B
save_results = True
terminate_on_event = False
filepath_source = "models/supremica/XML/human_model_scenario_A.xml" # don't forget to ajdust the path depending on wehther you want to similate scenario A or B
